...
# Write summary CSV
# -----------------------------
outfile = "greedy_removal_results.csv"
...
println("------------------------------------------")
println("Saved summary to: $outfile")
println("Saved each solution to: instances/QWFLOP_*/greedy_removal_solution_indices.txt")
